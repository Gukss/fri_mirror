  ...
  return (
    <div className="mainpage">
      ...
      <ul className="main_region">
        <li id={region == 1 ? "select" : "seoul"} onClick={() => setRegion(1)}>
          서울
        </li>
        <li
          id={region == 2 ? "select" : "daejeon"}
          onClick={() => setRegion(2)}
        >
          대전
        </li>
        <li id={region == 3 ? "select" : "gumi"} onClick={() => setRegion(3)}>
          구미
        </li>
        <li
          id={region == 4 ? "select" : "gwangju"}
          onClick={() => setRegion(4)}
        >
          광주
        </li>
        <li
          id={region == 5 ? "select" : "buulgyeong"}
          onClick={() => setRegion(5)}
        >
          부울경
        </li>
